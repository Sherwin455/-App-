        ...
        appBar: AppBar(
          bottom: TabBar(
            ...
            tabs: [
              ...
              Tab(icon: Icon(Icons.accessibility_sharp), child :Text(Strings.TITLE_student)),
              Tab(icon: Icon(Icons.account_balance_rounded), child :Text(Strings.TITLE_college)),
              Tab(icon: Icon(Icons.add_card), child :Text(Strings.TITLE_subject)),
            ],
          ),
          title: Center(
            child: Column(
