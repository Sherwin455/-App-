...
class iceState extends State<ice> {
  ...
  Widget build(BuildContext context) {
    ListTile makeListTile(Services services) => ListTile(
      ...
      trailing:
      Icon(Icons.keyboard_arrow_down_rounded, color: Colors.white, size: 30.0),
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
...
List getServices() {
  return [
    ...
    Services(
      title: Strings.TITLE_DPSR_PRICE,
      indicatorValue: 0.50,
    ),
    Services(
    ...
    Services(
      title: Strings.TITLE_DPSR_FEEDBACK,
      indicatorValue: 0.50,
    ),
    Services(
      title: Strings.TITLE_DPSR_DELIVERY,
      indicatorValue: 0.50,
    ),
  ];
}
